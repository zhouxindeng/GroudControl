...
public abstract class MissionBaseView extends RelativeLayout implements View.OnClickListener, PresentableView {
    ...
    protected Button waypoint_back, waypoint_add, waypoint_clear;
    protected Button usingPythonBtn;
    ...
    private void initUI(Context context) {
        ...
        usingPythonBtn=(Button) findViewById(R.id.btn_usingPython);
        ...
        usingPythonBtn.setOnClickListener(this);
    }
